...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manage.dawn.com/web/itemcat/all?callback=category.getDataService",
		//URL_Serv: "/js/item-cat-all.json",
		URL_Serv: "http://manage.dawn.com/rest/api/item/cat?callback=category.getDataService",
