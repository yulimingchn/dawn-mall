package com.dawn.store.order.dao;
...
import com.dawn.store.order.bean.Where;
import com.dawn.store.order.mapper.OrderMapper;
import com.dawn.store.order.pojo.Order;
import com.dawn.store.order.pojo.PageResult;
import com.dawn.store.order.pojo.ResultMsg;

/**
 * mysql版本的实现
 * 
 */
public class OrderDAO implements com.dawn.store.order.dao.IOrder {
